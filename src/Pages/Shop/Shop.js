        ...
        <div className="mPage_SH">
          <div className="line_SH p1_SH">
            <div className="texterDiv_SH">
              <h1 className="texter_SH">Наборы услуг</h1>
            ...
            <div className="texterDiv_SH ld_SH">
              <p className="texting_SH l_SH">
                Не знаете точно какой именно набор Вам нужен? <br></br> Напишите нам и Вам помогут
                определиться
              </p>
            </div>
          </div>
            ...
            <div className="chest_SH">
              <div className="head_SH">
                <div className="headText_SH">
                  <h2 className="packName_SH">Mini</h2>
                  <p className="price_SH">
                    9 BYN <br></br>
                    <span className="month_SH">в месяц</span>
                  </p>
                </div>
              </div>
              ...
              <div className="foot_SH">
                <button className="purchase_SH f_SH fh_SH">Купить</button>
              </div>
            </div>
            <div className="chest_SH">
              <div className="head_SH">
                <div className="headText_SH">
                  <h2 className="packName_SH">Standart</h2>
                  <p className="price_SH">
                    99 BYN <br></br>
                    <span className="month_SH">в месяц</span>
                  </p>
              ...
              <div className="foot_SH">
                <button className="purchase_SH s_SH sh_SH">Купить</button>
              </div>
            </div>
            <div className="chest_SH">
              <div className="head_SH">
                <div className="headText_SH">
                  <h2 className="packName_SH">Pro</h2>
                  <p className="price_SH">
                    999 BYN <br></br>
                    <span className="month_SH">в месяц</span>
                  </p>
              ...
              <div className="foot_SH">
                <button className="purchase_SH th_SH thh_SH">Купить</button>
              </div>
            </div>
            <div className="chest_SH">
              <div className="head_SH">
                <div className="headText_SH">
                  <h2 className="packName_SH">Ultimate</h2>
                  <p className="price_SH">
                    9999 BYN <br></br>
                    <span className="month_SH">в месяц</span>
                  </p>
              ...
              <div className="foot_SH">
                <button className="purchase_SH fo_SH foh_SH">Купить</button>
              </div>
            </div>
          </div>
        </div>
